...
var postgresVnetAddressPrefix = postgresLocation == 'centralus' ? '10.43.0.0/16' : postgresLocation == 'eastus' ? '10.44.0.0/16' : '10.45.0.0/16'
var postgresSubnetAddressPrefix = postgresLocation == 'centralus' ? '10.43.0.0/24' : postgresLocation == 'eastus' ? '10.44.0.0/24' : '10.45.0.0/24'
